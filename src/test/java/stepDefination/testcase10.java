...
public class testcase10 {
	...
	@When("^ date, month and year in date picker2 is selected $")
	public void  date_month_and_year_in_date_picker2_is_selected() throws InterruptedException 
	{
	...
	@Then("^ Date picker2 is verified $")
	public void Date_picker2_is_verified() 
	{
		System.out.println("Date picker2 is verified");		
	}
	/*	@After(order=1)
	public void logout()
	{
