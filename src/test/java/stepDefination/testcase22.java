...
public class testcase22 {
	...
	@When("^ User click on confirmation alert button $")
	public void  User_click_on_confirmation_alert_button() throws InterruptedException 
	{
		//Method to call Dashboard4
		Dashboard4 dashboard4 = new Dashboard4(driver);
		dashboard4.setConfirmationAlert();
	}
	@Then("^ confirmation alert pop up is displayed and verified  $")
	public void confirmation_alert_pop_up_is_displayed_and_verified() 
	{
		System.out.println("Confirmation alert pop up is displayed and verified");
	}
	/*	@After(order=1)
	public void logout()
	{
