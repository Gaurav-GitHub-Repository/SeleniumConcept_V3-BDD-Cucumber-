...
public class testcase13 {
	...
	@When("^ Retrieve all values from dynamic table  $")
	public void  Retrieve_all_values_from_dynamic_table() throws InterruptedException 
	{
	...
	@Then("^ Dynamic webtable is verified $")
	public void Dynamic_webtable_is_verified() 
	{
		System.out.println("Dynamic webtable is verified");		
	}
	/*	@After(order=1)
	public void logout()
	{
