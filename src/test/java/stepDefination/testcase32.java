...
public class testcase32 {
	...
	@When("^ Verify external link $")
	public void Verify_external_link() throws InterruptedException 
	{
		//Method to call Dashboard4
		Dashboard4 dashboard4 = new Dashboard4(driver);
		dashboard4.setLink();
	}
	@Then("^ External link is verified  $")
	public void  External_link_is_verified() 
	{
