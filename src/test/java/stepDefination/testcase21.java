...
public class testcase21 {
	...
	@When("^ User click on simple alert button $")
	public void  User_click_on_simple_alert_button() throws InterruptedException 
	{
		//Method to call Dashboard4
		Dashboard4 dashboard4 = new Dashboard4(driver);
		dashboard4.setSimpleAlert();	
	}
	@Then("^ Alert pop up is displayed and verified  $")
	public void Alert_pop_up_is_displayed_and_verified() 
	{
		System.out.println("Alert pop up is displayed and verified");
	}
	/*	@After(order=1)
	public void logout()
	{
