...
public class testcase12 {
	...
	@When("^ Retrieve all values from table $")
	public void  Retrieve_all_values_from_table() throws InterruptedException 
	{
	...
	@Then("^ Static webtable is verified  $")
	public void Static_webtable_is_verified () 
	{
		System.out.println("Static webtable is verified");		
	}
	/*	@After(order=1)
	public void logout()
	{
