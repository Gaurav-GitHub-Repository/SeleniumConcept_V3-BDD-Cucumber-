...
public class testcase31 {
	...
	@When("^ Verify scroll dropdown $")
	public void Verify_scroll_dropdown() throws InterruptedException 
	{
		//Method to call Dashboard4
		Dashboard4 dashboard4 = new Dashboard4(driver);
		dashboard4.setScrollDropdown();
	}
	@Then("^ Scroll dropdown is verified  $")
	public void  Scroll_dropdown_is_verified() 
	{
		System.out.println("Scroll dropdown is verified");
	}
	/*	@After(order=1)
	public void logout()
	{
