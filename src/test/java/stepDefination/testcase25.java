...
public class testcase25 {
	...
	@When("^ Verify window pop up $")
	public void Verify_window_pop_up() throws InterruptedException 
	{
		//Method to call Dashboard4
		Dashboard4 dashboard4 = new Dashboard4(driver);
		dashboard4.setWindow2();
	}
	@Then("^ Window2 is verified $")
	public void Window2_is_verified() 
	{
		System.out.println("Window2 is verified");
	}
	/*	@After(order=1)
	public void logout()
	{
